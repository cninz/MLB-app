...
fetch(`http://lookup-service-prod.mlb.com/json/named.sport_career_hitting.bam?league_list_id='mlb'&game_type='R'&player_id=${bonds}`)
...
fetch(`http://lookup-service-prod.mlb.com/json/named.search_player_all.bam?sport_code='mlb'&name_part='adam dunn'`)
    .then(res => res.json()) // parse response as JSON
    .then(data => {
...
async function addPlayerAndScoreOne(){
  ...
  await fetch(`http://lookup-service-prod.mlb.com/json/named.search_player_all.bam?sport_code='mlb'&name_part='${name}'`)
    .then(res => res.json()) // parse response as JSON
    .then(data => {
      console.log(data.search_player_all.queryResults.row.player_id)
    ...
    await fetch(`http://lookup-service-prod.mlb.com/json/named.sport_career_hitting.bam?league_list_id='mlb'&game_type='R'&player_id=${String(playerID)}`)
    .then(res => res.json()) // parse response as JSON
    .then(data => {
      console.log(data.sport_career_hitting.queryResults.row.ops)
